# credit @walkerkq
# https://github.com/walkerkq/musiclyrics/blob/master/01_songscrape.R
...
for (s in 1:length(allthesongs$Song))  {
  ...
  lyriclocs <- c("//p[@id='songLyricsDiv']", 
...
write.csv(allthesongs, "billboard_lyrics_2016-2017.csv", row.names=FALSE)
allthesongs <- read.csv("billboard_lyrics_2016-2017.csv", stringsAsFactors=FALSE)
